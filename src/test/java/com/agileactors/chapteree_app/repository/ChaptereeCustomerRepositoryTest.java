...
public class ChaptereeCustomerRepositoryTest {
    ...
    @Transactional
    void getOne() {
        ChaptereeCustomer chapCustomer = chaptereeCustomerRepository.getOne(new CustomerIds(1L, 2L));
    ...
    @Test
    void saveDelete() {
        CustomerIds customerIds = new CustomerIds(5L,2L);
        ...
        chaptereeCustomerRepository.deleteById(customerIds);
        assertFalse(chaptereeCustomerRepository.existsById(customerIds));
    }
